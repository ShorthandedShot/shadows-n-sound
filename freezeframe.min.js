! function(t, e) {
  ...
  return function(t) {
    ...
    var h, f, d = function() {
      ...
      p = (h = ["", ""], f = ["", ""], Object.freeze(Object.defineProperties(h, {
        raw: {
    ...
    var b = function() {
        ...
        return {
          onEndResult: function(e) {
            if ("initial" === t) {
              var n = e.match(/^[^\S\n]*(?=\S)/gm),
                i = n && Math.min.apply(Math, y(n.map((function(t) {
                  return t.length
                }))));
              if (i) {
    ...
    new I(G("\n"), w, b, v, j(/&/g, "&amp;"), j(/</g, "&lt;"), j(/>/g, "&gt;"), j(/"/g, "&quot;"), j(/'/g, "&#x27;"), j(/`/g, "&#x60;")), new I(Z(/(?:\n(?:\s*))+/g, " "), v), new I(Z(/(?:\n\s*)/g, ""), v), new I(w({
      ...
      separator: ",",
      conjunction: "and"
    }), Z(/(?:\s+)/g, " "), v), new I(w, b, v), new I(w, Z(/(?:\s+)/g, " "), v), new I(b, v), new I(b("all"), v);
    const R = ".freezeframe",
      Y = "ff-container",
      A = "ff-loading-icon",
      x = "ff-image",
  ...
  `);
        var i, r;
        return this.options.responsive && e.classList.add(z), this.options.overlay && e.appendChild(m(E`
    <div class="${M}">
    </div>
  `)), t.classList.add(x), e.appendChild(n), r = e, (i = t).parentNode.insertBefore(r, i), r.appendChild(i), {
          $container: e,
          $canvas: n,
          $image: t
        }
      ...
      _process(t) {
        return new Promise(e => {
          ...
          n.setAttribute("width", o.toString()), n.setAttribute("height", s.toString());
          n.getContext("2d").drawImage(i, 0, 0, o, s), n.classList.add(k), n.addEventListener("transitionend", () => {
            this._ready(r), e(t)
          }, {
            once: !0
          })
      ...
      _injectStylesheet() {
        this._stylesInjected || document.head.appendChild(m(E(`\n    <style id="ff-styles">\n      ${X.a.toString()}\n    </style>\n  `)))
      }
      _emit(t, e, n) {
      ...
      _toggleOn(t) {
        ...
        e.classList.contains(J) && (n.setAttribute("src", n.src), e.classList.remove(F), e.classList.add(L))
      }
      _toggleOff(t) {
        const {
          $container: e
        } = t;
        e.classList.contains(J) && (e.classList.add(F), e.classList.remove(L))
      }
      _toggle(t) {
        const {
          $container: e
        } = t, n = e.classList.contains(L);
